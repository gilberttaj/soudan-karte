            ...
            <ScrollView className=''>
                <View className='bg-white'>
                    <View className='pt-4 border mt-5 mb-3 mx-3'>
                        ...
                        <View className='pl-5 mb-8'>
                            <Text className='text-primary'>相統有無</Text>
                            <Text>{position}</Text>
                        </View>

                        <View className='pl-5 mb-8'>
                            <Text className='text-primary'>資產值</Text>
                            <Text>{accidentSituation}</Text>
                        </View>

                        <View className='pl-5 mb-8'>
                            <Text className='text-primary'>不動產有無</Text>
                            <Text>{accidentType}</Text>
                        </View>
                        
                        <View className='pl-5 mb-8'>
                            <Text className='text-primary'>相続人数</Text>
                            <Text>{injury}</Text>
                        </View>

                        <View className='pl-5 mb-8'>
                            <Text className='text-primary'>相談内容</Text>
                            <Text>{insuranceCoverageStatus}</Text>
                        </View>

                        <View className='pl-5 mb-8'>
                          <Text className='text-primary'>相統時期</Text>
                          <Text>{moment(dateOfAccident).format('YYYY/MM/DD').toString()}</Text>
                        </View>
